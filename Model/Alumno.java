...
public class Alumno implements Serializable {
    ...
    public Alumno(String noControl, String nombre, String paterno, String materno, Double calificacion, Carrera carrera) throws CalificacionException, NumeroException, ApellidoException, CarreraException, VacioException  {
        this.setNoControl(noControl);
        this.setVacio (nombre);
    ...
    public void setVacio(String nombre) throws VacioException  {
        if (!nombre.isEmpty()) {
            this.nombre = nombre;
        } else {
            throw new VacioException ("Campo NOMBRE vacio");
        }
    }
